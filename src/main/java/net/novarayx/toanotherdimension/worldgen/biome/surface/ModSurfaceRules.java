    ...
    public static SurfaceRules.RuleSource makeRules()
    {
        ...
        return SurfaceRules.sequence(
                SurfaceRules.sequence(
                        SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.NOVARITE_BIOME), SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, NOVARITE_DIRT)),
                        SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, NOVARITE_BRICK),
                        SurfaceRules.ifTrue(SurfaceRules.DEEP_UNDER_FLOOR, NOVARITE_BRICK),
